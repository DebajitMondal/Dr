...
function setup() {
  ...
  Ground = createSprite(windowWidth-1200,windowHeight-100,1500,10)
 ...
 invisibleGround = createSprite(windowWidth-1200,windowHeight-100,1500,10);
...
function draw() {  
 ...
 if (GameState === 1){
  ...
  if(Point>9){ 
    if(keyDown("space") && Goku.y >= Ground.y-100 ) {
      Goku.velocityY = -25;
...
function createBall2() {
 ...
 function Spawnenemy(){
  if(frameCount % 200 === 0) {
    var Enemy = createSprite(920,Ground.y-70,10,40);
